...
<body>
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Edit Service Area</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-title">
                                <h5 class="float-left">Edit Service Area</h5>

                            </div>
                            <div class="ibox-content">

                                <form id="edit_service_areas_form" action="" method="post" class="form-horizontal">

                                    <input type="hidden" name="area_id" value="<?php echo $area_detail['id']; ?>">

                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Area Title</label>
                                        <div class="col-sm-10">
                                            <input type="text" name="area_title" id="area_title" class="form-control" required="required" placeholder="Area Title" value="<?php echo $area_detail['area_title']; ?>">
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        $("#edit_service_areas_form").validate();
        ...
        $(document).on("click", "#add_service_areas_btn", function(e) {
            ...
            if($("#edit_service_areas_form").valid()) {

                e.preventDefault();
                var formData = $("#edit_service_areas_form").serialize();
                var ajaxurl = '<?php echo admin_url().'service_areas/update_service_areas'; ?>';
                ...
                $.ajax({
                    ...
                    success: function(data ) {
                        if(data.msg =='error') {
                            ...
                            jQuery('#edit_service_areas_form')[0].reset();
